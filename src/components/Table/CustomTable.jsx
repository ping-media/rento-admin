...
import { formatDate, formatFullDateAndTime } from "../../utils/index.js";
...
const CustomTable = ({ pageTitle, Data }) => {
  ...
  const getTableHeaderAndTableValue = (Data) => {
    ...
    const header = ["SNO", ...filteredKeys, "Actions"];
        ...
        <div className="flex flex-col">
          <div className=" overflow-x-auto pb-4 no-scrollbar">
            <div className="min-w-full inline-block align-middle">
              <div className="overflow-hidden border shadow-lg rounded-lg border-gray-200">
